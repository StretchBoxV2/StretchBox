      ...
      <div className="stretchDisplayHeader">
        ...
        {isViewingFavorites ? (
          ...
          <>
            ...
            {user && (
                <svg onClick={() => dispatch(toggleViewingFavorites())} xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-bookmark-heart" viewBox="0 0 16 16">
